...
public class FormController {
    ...
    private final FoxianRepository foxianRepository;
    ...
    public FormController(
            ...
            FoxianRepository foxianRepository
    ) {
        ...
        this.foxianRepository = foxianRepository;
    }
    ...
    @PostMapping("/submit-foxian")
    public FoxianDTO handleFormSubmit(@RequestBody FoxianDTO requestBody) {
        Foxian entity = new Foxian();
        entity.setInternName(requestBody.getInternName());
        Foxian savedEntity = foxianRepository.save(entity);
        return new FoxianDTO(savedEntity.getId(), savedEntity.getInternName());
    }
